...
where @URL@ is the URL of the plugin from the compatibility table. For examples to install version @2.1.0@ run

<pre>
bin/plugin install http://dl.bintray.com/content/imotov/elasticsearch-plugins/org/elasticsearch/elasticsearch-analysis-morphology/2.1.0/elasticsearch-analysis-morphology-2.1.0.zip
</pre>
