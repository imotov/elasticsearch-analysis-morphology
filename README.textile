...
where @VERSION@ is the version of the plugin from the compatibility table. For examples to install version @1.2.0@ run

<pre>
bin/plugin -install analysis-morphology -url http://dl.bintray.com/content/imotov/elasticsearch-plugins/elasticsearch-analysis-morphology-1.2.0.zip
</pre>
