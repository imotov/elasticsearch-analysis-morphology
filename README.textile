...
| 5.6.16                          | 5.6.16 | https://dl.bintray.com/content/jfkz/elasticsearch-plugins/org/elasticsearch/elasticsearch-analysis-morphology/5.6.16/elasticsearch-analysis-morphology-5.6.16.zip |
...
where @URL@ is the URL of the plugin from the compatibility table. For examples to install version @5.6.15@ run
