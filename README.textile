...
| 5.6.16                          | 5.6.16 | http://dl.bintray.com/content/imotov/elasticsearch-plugins/org/elasticsearch/elasticsearch-analysis-morphology/5.6.16/elasticsearch-analysis-morphology-5.6.16.zip |
| 5.6.15                          | 5.6.15 | http://dl.bintray.com/content/imotov/elasticsearch-plugins/org/elasticsearch/elasticsearch-analysis-morphology/5.6.15/elasticsearch-analysis-morphology-5.6.15.zip |
...
where @URL@ is the URL of the plugin from the compatibility table. For examples to install version @5.6.16@ run
